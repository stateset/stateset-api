...
async fn create_purchase_order(
    ...
    let po_id = state.services.procurement
...
async fn get_purchase_order(
    ...
    let po = state.services.procurement
...
async fn receive_purchase_order(
    ...
    let items_received = payload.items_received.into_iter()
...
async fn get_purchase_orders_by_supplier(
    ...
    let pos = state.services.procurement
...
async fn get_total_purchase_value(
    ...
    let total_value = state.services.procurement
