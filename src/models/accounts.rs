...
impl Model {
    ...
    pub fn set_billing_address(&mut self, street: String, city: String, state: String, country: String) {
    ...
    pub fn set_shipping_address(&mut self, street: String, city: String, state: String, country: String) {
