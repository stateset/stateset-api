...
impl Model {
    ...
    pub fn update_quantity(&mut self, new_quantity: i32) {
        ...
        self.total_price = (self.unit_price * new_quantity as f64) - self.discount_amount + self.tax_amount;
        self.updated_at = Utc::now();
    }
    ...
    pub fn apply_discount(&mut self, discount_amount: f64) {
        ...
        self.total_price = (self.unit_price * self.quantity as f64) - discount_amount + self.tax_amount;
        self.updated_at = Utc::now();
    }
}