...
impl Model {
    ...
    pub fn set_mailing_address(&mut self, street: String, city: String, state: String, country: String) {
    ...
    pub fn set_communication_preferences(&mut self, do_not_call: bool, email_opt_out: bool, fax_opt_out: bool) {
