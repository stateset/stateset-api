        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(OrderItems::Discount).decimal().not_null().default(0.0))
                    .col(ColumnDef::new(OrderItems::TaxRate).decimal().not_null().default(0.0))
                    .col(ColumnDef::new(OrderItems::TaxAmount).decimal().not_null().default(0.0))
                    .col(ColumnDef::new(OrderItems::Status).string().not_null().default("pending"))
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .to(super::m20230101_000001_create_orders_table::Orders::Table, super::m20230101_000001_create_orders_table::Orders::Id)
