        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(Warranties::Id).uuid().primary_key().not_null())
                    .col(ColumnDef::new(Warranties::WarrantyNumber).string().not_null().unique_key())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(WarrantyClaims::Id).uuid().primary_key().not_null())
                    .col(ColumnDef::new(WarrantyClaims::WarrantyId).uuid().not_null())
                    .col(ColumnDef::new(WarrantyClaims::ClaimNumber).string().not_null().unique_key())
                    .col(ColumnDef::new(WarrantyClaims::Status).string().not_null())
                    .col(ColumnDef::new(WarrantyClaims::ClaimDate).date_time().not_null())
                    .col(ColumnDef::new(WarrantyClaims::Description).text().not_null())
                    .col(ColumnDef::new(WarrantyClaims::Resolution).text().null())
                    .col(ColumnDef::new(WarrantyClaims::ResolvedDate).date_time().null())
                    .col(ColumnDef::new(WarrantyClaims::CreatedAt).timestamp().not_null())
