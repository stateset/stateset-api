        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Orders::TotalAmount).decimal().not_null().default(0.0))
                    .col(ColumnDef::new(Orders::Currency).string().not_null().default("USD"))
                    .col(ColumnDef::new(Orders::PaymentStatus).string().not_null().default("pending"))
                    .col(ColumnDef::new(Orders::FulfillmentStatus).string().not_null().default("unfulfilled"))
